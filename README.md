  ...
  > src.main.java.com.example.demo
    ...
    > src
      ...
      > user
        ...
        | UserService.java
        | UserDao.java
      | WebSecurityConfig.java // Spring Security 설정 (JWT 사용 및 CORS 관련 설정이 작성되어 있음) (5주차)
    > utils
      | AES128.java // 암호화 관련 클래스 (5주차)
      | JwtService.java // jwt 관련 클래스 (5주차)
      | ValidateRegex.java // 정규표현식 관련 클래 (5주차)
